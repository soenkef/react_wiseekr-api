...
CAMERA_MANUFACTURERS = [
    ...
    "iCam", "IDIS", "INFINITY", "INTELLIKO", "InterVision", "IPEYE", "IPneo", "IPS", "IPTRONIC", "iRUS", "iTechPRO", "iTS",
    "J2000IP", "Jassun",
    "KEDACOM", "KENO",
    ...
    "Panasonic", "Partizan", "PBT", "Pensee", "Pinetron", "Polyvision", "Powertone", "PRAXIS", "ProfVideo", "Proto-X", "PROvision", "PROXISCCTV",
    "QBOR", "Qihan", "QTECH",
    "Ratingsecu", "RedLine", "Reolink", "ROKA", "RVi",
    "SafeTech", "SAMSUNG", "Santrin", "SANYO", "Sarmatt", "Sateko", "Satvision", "SECTEC", "Smartec", "SNR", "Solkorn", "SOWA", "Spacetechnology", "SpezVision", "SpyG", "SPYMAX", "StarDot", "Sunell", "SVN", "SVPlus",
    "Tantos", "Target", "TBTEC", "Telenova", "Tiandy", "Tigris", "TRENDnet", "TRUEN",
    "Umbrella", "Uniview",
