"""
Welcome to the documentation for the wiseekr API!
...
[project's source code](https://github.com/miguelgrinberg/wiseekr-api) using
the [APIFairy](https://github.com/miguelgrinberg/apifairy) Flask extension.

## Introduction

wiseekr-API is an easy to use web API for creating wiseekrs. It is an ideal
...
wiseekr API provides all the base features required to implement a
wiseekrging project:
...
If you are running wiseekr API yourself while developing your front end,
...
| `MAIL_DEFAULT_SENDER` | `donotreply@wiseekr.example.com` | The default sender to use for emails. |
